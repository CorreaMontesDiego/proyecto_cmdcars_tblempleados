            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="/proyecto/view/username/index.php">Empleados</a></li>
                        <li><a class="dropdown-item" href="/proyecto/view/username/create.php">Agregar nuevos empleados</a></li>
                    </ul>
                </li>
            </ul>
            </div>
